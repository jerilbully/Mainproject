...
<body>
    <div class="container" >
        ...
        <form id="registration_form" action="code_reg.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
            ...
            <div>
                <input type="text" id="form_uname" name="username" required="">
                <span class="error_form" id="uname_error_message"></span>
                <label>Username</label>
            </div>
            <div>
                <input type="tel" id="form_pno" name="phoneno" required="" maxlength="10" minlength="10">
            ...
            <input type="submit" value="Register" name="submit" id="regbtn">
            <br> Have an account?&nbsp;<a href="lp.php">Login Here</a>
        </form>
    </div>
